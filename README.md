...
[![CI](https://github.com/namitdeb739-aug/test-ml-v2/actions/workflows/ci.yml/badge.svg)](https://github.com/namitdeb739-aug/test-ml-v2/actions/workflows/ci.yml)
[![Docs](https://github.com/namitdeb739-aug/test-ml-v2/actions/workflows/docs.yml/badge.svg)](https://namitdeb739-aug.github.io/test-ml-v2/)
[![CodeQL](https://github.com/namitdeb739-aug/test-ml-v2/actions/workflows/codeql.yml/badge.svg)](https://github.com/namitdeb739-aug/test-ml-v2/actions/workflows/codeql.yml)
...
.
├── src/
│   └── test_ml_v2/          # Source package (src layout)
│       ├── __init__.py
│       ├── main.py            # Entry point
...
The docs site will be available at `https://namitdeb739-aug.github.io/test-ml-v2/`.
...
2. Enter: GitHub repo `namitdeb739-aug/test-ml-v2`, workflow `publish.yml`, environment `pypi`
...
```bash
just docker-build-gpu    # or: docker build -f Dockerfile.gpu -t test-ml-v2-gpu .
```
...
The template uses [bump-my-version](https://github.com/callowayproject/bump-my-version) to keep version numbers in sync across `pyproject.toml` and `src/test_ml_v2/__init__.py`:
...
| `src/test_ml_v2/config.py` | Typed dataclass configuration (see below) |

### Configuration

`src/test_ml_v2/config.py` provides a typed, dataclass-based config pattern:

```python
from test_ml_v2.config import Config
